...
// class Shader : public QOpenGLShader, public QOpenGLFunctions_3_3_Core{
// public:
//     unsigned int ID;
...
// private:
//     void init(std::string vertexCode, std::string fragmentCode, std::string geometryCode = "") {
//         const char* vShaderCode = vertexCode.c_str();
//         const char * fShaderCode = fragmentCode.c_str();
//         // 2. compile shaders
//         unsigned int vertex, fragment;
